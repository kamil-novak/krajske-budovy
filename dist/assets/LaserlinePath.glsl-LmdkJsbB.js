import{Fl as be,Fh as we,FE as De,vG as f,vQ as w,Fq as Ve,DM as W,vH as r,dB as z,vI as ee,Fk as xe,vO as y,bD as te,bA as A,fM as B,FF as Ee,gf as ie,vF as ne,E5 as S,dN as _,bz as v,FG as se,vS as ae,bB as o,lq as re,fL as Le,q5 as ye,bE as Se,bQ as le,fI as oe,fJ as Ce,Fi as Me,vk as Ae,E3 as $e,EJ as Re,vR as H,dP as Te,pr as ce,pt as he,_ as de,dQ as Oe,dT as G,oy as U,i as c,n as F,hz as pe,dR as ue,bx as Ie,bC as I,mE as qe,Eg as Ue,Eh as ze,FH as Fe,vZ as V,mH as je,mI as k,FI as Ne,rq as We,FJ as $,FK as Be,Fr as Q,q1 as He,t8 as Ge,q2 as ke,q3 as Qe,q4 as Je,q6 as Xe,m as C,FL as Ze,gD as J}from"./index-CDFYXRI5.js";import{t as Ke}from"./VisualElement-Ch0bDrIB.js";function fe(t,e){const n=t.fragment;n.include(be),t.include(we),n.include(De),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new W("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
}`)}const j=z(6);function ge(t){const e=new ee;e.include(xe),e.include(fe,t);const n=e.fragment;if(t.lineVerticalPlaneEnabled||t.heightManifoldEnabled)if(n.uniforms.add(new f("maxPixelDistance",(i,s)=>t.heightManifoldEnabled?2*s.camera.computeScreenPixelSizeAt(i.heightManifoldTarget):2*s.camera.computeScreenPixelSizeAt(i.lineVerticalPlaneSegment.origin))),n.code.add(r`float planeDistancePixels(vec4 plane, vec3 pos) {
...
}`)),n.main.add(r`fragColor = laserlineOutput(color * depthDiscontinuityAlpha);`),e}function M(t){return re(nt,Math.cos(t.angleCutoff),Math.cos(Math.max(0,t.angleCutoff-z(2))))}function Ye(t,e){return _(q,t.pointDistanceOrigin,e.camera.viewMatrix),q[3]=ie(t.pointDistanceOrigin,t.pointDistanceTarget),q}function et(t,e){const n=ye(t.lineVerticalPlaneSegment,.5,u),i=t.renderCoordsHelper.worldUpAtPosition(n,st),s=A(D,t.lineVerticalPlaneSegment.vector),a=Se(u,i,s);return A(a,a),me(t.lineVerticalPlaneSegment.origin,a,e.camera.viewMatrix)}function tt(t,e){const n=v(u,t.lineVerticalPlaneSegment.origin);return t.renderCoordsHelper.setAltitude(n,0),_(n,n,e.camera.viewMatrix)}function it(t,e){const n=le(u,t.lineVerticalPlaneSegment.origin,t.lineVerticalPlaneSegment.vector);return t.renderCoordsHelper.setAltitude(n,0),_(n,n,e.camera.viewMatrix)}function me(t,e,n){return _(X,t,n),v(d,e),d[3]=0,se(d,d,n),Le(X,d,at)}const nt=oe(),u=o(),d=ae(),st=o(),D=o(),X=o(),at=Ce(),q=ae(),rt=Object.freeze(Object.defineProperty({__proto__:null,build:ge,defaultAngleCutoff:j},Symbol.toStringTag,{value:"Module"}));function _e(t){const e=new ee;e.include(fe,t);const{vertex:n,fragment:i}=e;n.uniforms.add(new Me("modelView",(a,{camera:l})=>Ae(ot,l.viewMatrix,a.origin)),new $e("proj",({camera:a})=>a.projectionMatrix),new f("glowWidth",(a,{camera:l})=>a.glowWidth*l.pixelRatio),new Re("pixelToNDC",({camera:a})=>re(lt,2/a.fullViewport[2],2/a.fullViewport[3]))),e.attributes.add("start","vec3"),e.attributes.add("end","vec3"),t.spherical&&(e.attributes.add("startUp","vec3"),e.attributes.add("endUp","vec3")),e.attributes.add("extrude","vec2"),e.varyings.add("uv","vec2"),e.varyings.add("vViewStart","vec3"),e.varyings.add("vViewEnd","vec3"),e.varyings.add("vViewSegmentNormal","vec3"),e.varyings.add("vViewStartNormal","vec3"),e.varyings.add("vViewEndNormal","vec3");const s=!t.spherical;return n.main.add(r`
